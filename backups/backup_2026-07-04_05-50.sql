...
\restrict QHlbubPybHfdeI8VhnEjzQSNbKDhF3k8cM4r1ckd4BSvfvpMagOIaPAv4a8GUpq
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6894, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13635, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6812, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6807, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16091, true);
...
\unrestrict QHlbubPybHfdeI8VhnEjzQSNbKDhF3k8cM4r1ckd4BSvfvpMagOIaPAv4a8GUpq

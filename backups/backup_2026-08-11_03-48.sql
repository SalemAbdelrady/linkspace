...
\restrict OabYUBmC1IAgIziSNQhrxHOLnekdhzPgTvt7Egxtc8P9hV1hgGmQovz3lJm3oZI
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7197, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14241, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7115, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7110, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16798, true);
...
\unrestrict OabYUBmC1IAgIziSNQhrxHOLnekdhzPgTvt7Egxtc8P9hV1hgGmQovz3lJm3oZI

...
\restrict zHkxOgdWXFrECgdAiwiBSLHAwXTVARp60VjPD7tTnOh3ggelt2jkbqTrlBczfuJ
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6153, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12159, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6071, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6069, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 14369, true);
...
\unrestrict zHkxOgdWXFrECgdAiwiBSLHAwXTVARp60VjPD7tTnOh3ggelt2jkbqTrlBczfuJ

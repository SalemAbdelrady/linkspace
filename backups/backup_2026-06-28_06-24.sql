...
\restrict Fbi28eisRyhkQmk9Hxwb9tZSIDnv8fbcJjLQt8r1qTb1XHEWa2e9KmLdsKwP06O
...
19	9011	meeting	غرفة الاجتماعات	2026-06-27	12:30:00	14:00:00	1	pending	\N	9011	\N	\N	\N	2026-06-27 06:10:23.635995+00	2026-06-27 06:10:23.635995+00	\N	\N
\.
...
16	73	booking_created	📅 تم إرسال طلب حجزك	تم إنشاء حجز لـ غرفة الدروس يوم 2026-06-21 (20:00–22:00) بنجاح — في انتظار التأكيد	17	booking	f	2026-06-21 01:08:17.187978
17	73	booking_confirmed	✅ تم تأكيد حجزك	تم تأكيد حجزك لـ غرفة الدروس يوم 2026-06-20 (20:00–22:00)	17	booking	f	2026-06-21 01:09:34.755104
...
8996	مصطفى قمر	01029947837	$2a$12$zfaozWNhi.cIYD43p.9zR.Nn/vfbUZzFV4Pl1pXII8rji3zb6C59.	client	0.00	64	4349245	f	2026-05-17 20:08:53.785036+00	2026-05-17 20:08:53.785036+00	\N	moftafa.mohamed.link@gmail.com	f	\N	\N	f	f	f	f	f	\N	REF-UA0D	\N	0	0
...
SELECT pg_catalog.setval('public.invoices_id_seq', 181, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6564, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12981, true);
...
SELECT pg_catalog.setval('public.session_orders_id_seq', 115, true);
...
SELECT pg_catalog.setval('public.sessions_id_seq', 189, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6482, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6480, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 15328, true);
...
\unrestrict Fbi28eisRyhkQmk9Hxwb9tZSIDnv8fbcJjLQt8r1qTb1XHEWa2e9KmLdsKwP06O

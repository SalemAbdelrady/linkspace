...
\restrict GjUT9YaNwCl9uMXkv6CP2qEIhMBAwRT2O1fyhz1kMna7GkyLH7F1BYxl6jCq0ih
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6672, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13197, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6590, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6588, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 15580, true);
...
\unrestrict GjUT9YaNwCl9uMXkv6CP2qEIhMBAwRT2O1fyhz1kMna7GkyLH7F1BYxl6jCq0ih

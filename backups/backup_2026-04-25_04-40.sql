...
\restrict Q2J2tm6pMI57bxaxrxheoWBrxbqQrZUf1sr8SbK9nie8tnreX5VlPZyXrnst5dP
...
1	باقة أساسية	500.00	دخول غير محدود لمنطقة العمل	0	t	2026-03-24 22:39:49.177984+00	2026-03-24 22:39:49.177984+00	t
2	باقة بريميوم	900.00	دخول غير محدود + خصم 20% على الغرف	20	t	2026-03-24 22:39:49.177984+00	2026-03-24 22:39:49.177984+00	t
3	باقة VIP	1400.00	دخول غير محدود + خصم 40% على الغرف	40	t	2026-03-24 22:39:49.177984+00	2026-03-24 22:39:49.177984+00	t
\.
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 300, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 439, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 216, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 216, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 708, true);
...
SELECT pg_catalog.setval('public.wallet_transactions_id_seq', 43, true);
...
\unrestrict Q2J2tm6pMI57bxaxrxheoWBrxbqQrZUf1sr8SbK9nie8tnreX5VlPZyXrnst5dP

...
\restrict cFJ4azmfekearkSfgLJcNal1bYrdEXQYHDsBa2hqhSd2AuN8S1kETeddSRm6uVY
...
161	سالم عبدالواحد	01029947834	$2a$12$aM5G3Aw7UyhsJG7cE0Y.2uZcThPSKrohkdSqwXljuldKZ7BD4zy9i	client	0.00	357	7536108	t	2026-03-22 17:43:51.399835+00	2026-03-22 17:43:51.399835+00	\N
75	احمد عبد الرحيم ربيع	01019839140	$2a$12$OcJ1ldKqVyG84Wxle5pxMeC11hfXdKUHu.golKW94X2EK7SozP1sa	client	20.00	263	3478485	t	2026-03-21 22:35:08.397302+00	2026-03-21 22:35:08.397302+00	\N
\.
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 603, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 1046, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 519, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 519, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 1415, true);
...
\unrestrict cFJ4azmfekearkSfgLJcNal1bYrdEXQYHDsBa2hqhSd2AuN8S1kETeddSRm6uVY

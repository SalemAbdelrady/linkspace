...
\restrict awI4c9MIU5y81NHOVddbiKbC7SvwMHTpwxiPpalZsf0gqimSBDEDBzDxLS43OJJ
...
161	سالم عبدالواحد	01029947834	$2a$12$aM5G3Aw7UyhsJG7cE0Y.2uZcThPSKrohkdSqwXljuldKZ7BD4zy9i	client	0.00	363	7536108	t	2026-03-22 17:43:51.399835+00	2026-04-29 23:23:07.859574+00	\N	salem.abdul-radi@hotmail.com	f	221761	2026-04-30 22:27:54.363+00
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 882, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 1604, true);
...
SELECT pg_catalog.setval('public.session_orders_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 798, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 798, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 2066, true);
...
\unrestrict awI4c9MIU5y81NHOVddbiKbC7SvwMHTpwxiPpalZsf0gqimSBDEDBzDxLS43OJJ

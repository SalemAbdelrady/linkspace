...
\restrict 1yXRDKHynPqZuNrDQM4G6CxcvBKXY6K6gUx3faItkNOzNNdlVm2c6fkdpIvWHNM
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5439, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10731, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5355, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5355, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12708, true);
...
\unrestrict 1yXRDKHynPqZuNrDQM4G6CxcvBKXY6K6gUx3faItkNOzNNdlVm2c6fkdpIvWHNM

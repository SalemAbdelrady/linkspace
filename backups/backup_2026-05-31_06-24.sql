...
\restrict pxqQOQ9nIvRnhdg6BDmG5wapJBwpIRtChmq4dTxANdW8q0olusvWfgmuHEHPc5Y
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5298, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10449, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5214, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5214, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12379, true);
...
\unrestrict pxqQOQ9nIvRnhdg6BDmG5wapJBwpIRtChmq4dTxANdW8q0olusvWfgmuHEHPc5Y

...
\restrict M4og5f3KQ7MwLizoHutOhN5L2oTNhMg6cRJyftbNcOjhKH4tuJPidw0XW78oCwX
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7158, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14163, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7076, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7071, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16707, true);
...
\unrestrict M4og5f3KQ7MwLizoHutOhN5L2oTNhMg6cRJyftbNcOjhKH4tuJPidw0XW78oCwX

...
\restrict 0dkDSt76SAbaaR9fhwLrgeghpQAcGmG7eP896qacHexsN68KnfN7TRBLu50tP8l
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5295, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10443, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5211, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5211, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12372, true);
...
\unrestrict 0dkDSt76SAbaaR9fhwLrgeghpQAcGmG7eP896qacHexsN68KnfN7TRBLu50tP8l

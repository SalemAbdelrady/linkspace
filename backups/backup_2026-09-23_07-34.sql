...
\restrict V4YAIObvbLUbgvWzJM0gySZdm9pDJRRnHHNiA0dwAPsFpVNFP6DXkoGeqaw6wiH
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7356, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 153, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14559, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7274, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7269, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 17169, true);
...
\unrestrict V4YAIObvbLUbgvWzJM0gySZdm9pDJRRnHHNiA0dwAPsFpVNFP6DXkoGeqaw6wiH

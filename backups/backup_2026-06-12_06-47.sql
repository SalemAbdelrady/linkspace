...
\restrict mR0umtylW0dyMZSaUzd7mQOpkBReWFDbcXABQFAFSwcxw9jIpjYgLBr2Wuj6Jr6
...
176	161	2026-06-11 20:45:33.357495+00	\N	\N	25.00	\N	wallet	active	2026-06-11 20:45:33.357495+00	cowork	منطقة العمل المشتركة	4	\N	f	2	1
...
1	2291	f	t	t	t	\N	2026-05-02 21:48:53.793165+00	2026-06-12 01:55:05.981545+00	t	t
\.
...
9011	قمر قمر	01029947838	$2a$12$qNLltyuRY7Zy4oXxF5mzousqx8PDnG4kXTI/tGgow.Li5Y60foj0W	client	0.00	90	3576587	t	2026-05-17 20:11:10.509347+00	2026-05-17 20:11:10.509347+00	\N	Tb3.moftafaqmarll.link@gmail.com	f	\N	\N	f	f	f	f	f	\N	REF-ZXTO	\N	0	0
...
SELECT pg_catalog.setval('public.invoices_id_seq', 160, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5400, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10653, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5316, true);
...
SELECT pg_catalog.setval('public.staff_permissions_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5316, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12617, true);
...
\unrestrict mR0umtylW0dyMZSaUzd7mQOpkBReWFDbcXABQFAFSwcxw9jIpjYgLBr2Wuj6Jr6

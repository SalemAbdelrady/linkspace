...
\restrict GjCMZa9KwTbCJISND2Bwps4Ifu4P7dS0pQOWU709oNgOrBbHjrAwq7HJtBKFbpe
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6870, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13587, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6788, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6783, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16035, true);
...
\unrestrict GjCMZa9KwTbCJISND2Bwps4Ifu4P7dS0pQOWU709oNgOrBbHjrAwq7HJtBKFbpe

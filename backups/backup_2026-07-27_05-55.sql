...
\restrict fnMESeDzh8zvJP6pVH46CqDWidAHanUYCHiir1riDLTZ8MFlgEBpKA8Q5dgVe0a
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7179, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14205, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7097, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7092, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16756, true);
...
\unrestrict fnMESeDzh8zvJP6pVH46CqDWidAHanUYCHiir1riDLTZ8MFlgEBpKA8Q5dgVe0a

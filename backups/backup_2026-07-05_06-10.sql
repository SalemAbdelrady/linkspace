...
\restrict C9hlLrb8la9WvuDqz3AUCU8FSxfoONrVkAImQgFqBPLmYO0rz8guzWDuOe2Vvbq
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6906, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13659, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6824, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6819, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16119, true);
...
\unrestrict C9hlLrb8la9WvuDqz3AUCU8FSxfoONrVkAImQgFqBPLmYO0rz8guzWDuOe2Vvbq

...
\restrict L8PZVyq501QTcBVRqejGXVU3TcZeDDJ3rDz2pWIgCuimd9SgCoDXeUd6H0bx4kb
...
3	8996	meeting	غرفة الاجتماعات	2026-06-17	09:00:00	11:00:00	4	pending	\N	1	\N	\N	\N	2026-06-15 21:03:07.024227+00	2026-06-15 21:03:07.024227+00
...
5	4515	meeting	غرفة الاجتماعات	2026-06-20	12:00:00	13:30:00	6	pending	\N	4515	\N	\N	\N	2026-06-15 21:40:46.435196+00	2026-06-15 21:40:46.435196+00
\.
...
9124	الكبير أوي	01029947839	$2a$12$mRwgteHx08FRbuyztUVJ/.6IbYFuPDnyo2fn1eRWy5eTzRhIbt9u2	client	2.00	0	2158503	t	2026-05-17 23:22:06.431347+00	2026-05-17 23:22:06.431347+00	\N	alkabeer.link@gmail.com	f	\N	\N	f	f	f	f	f	\N	REF-CWZX	161	0	0
...
SELECT pg_catalog.setval('public.invoices_id_seq', 166, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5745, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 11343, true);
...
SELECT pg_catalog.setval('public.sessions_id_seq', 180, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5661, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5661, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 13422, true);
...
\unrestrict L8PZVyq501QTcBVRqejGXVU3TcZeDDJ3rDz2pWIgCuimd9SgCoDXeUd6H0bx4kb

...
\restrict dyGQENHAIOAlT9e72EEjvvrJLft4PuOKvIxSOmNGY2i7TaStyysZJeU1IBDy6VU
...
1	2291	f	f	t	t	\N	2026-05-02 21:48:53.793165+00	2026-06-12 23:36:12.498087+00	f	f
\.
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6951, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 130, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13749, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6869, true);
...
SELECT pg_catalog.setval('public.staff_permissions_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6864, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16224, true);
...
\unrestrict dyGQENHAIOAlT9e72EEjvvrJLft4PuOKvIxSOmNGY2i7TaStyysZJeU1IBDy6VU

...
\restrict SYvy0gSJlP4F4AIo7mFYFNS0xJK4w1ZasGZEtN2sw9AjcsPsbe4RdSCpBt0Z6dp
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 4851, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 9553, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 4767, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 4767, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 11336, true);
...
\unrestrict SYvy0gSJlP4F4AIo7mFYFNS0xJK4w1ZasGZEtN2sw9AjcsPsbe4RdSCpBt0Z6dp

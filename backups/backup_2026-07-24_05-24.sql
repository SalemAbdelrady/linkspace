...
\restrict OuAGt3gdKi5bgBuroX2GbLat4AYvipx5mMCfC0IyDQdpqpY70sYYQdRR9TmEUXu
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7053, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13953, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6971, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6966, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16462, true);
...
\unrestrict OuAGt3gdKi5bgBuroX2GbLat4AYvipx5mMCfC0IyDQdpqpY70sYYQdRR9TmEUXu

...
\restrict JX0vXanV0M8njgfgbdjBesR03wgOU9SZfj7z8xLX1jYGHhXjCahhIifjrL0gSJB
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7188, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14223, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7106, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7101, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16777, true);
...
\unrestrict JX0vXanV0M8njgfgbdjBesR03wgOU9SZfj7z8xLX1jYGHhXjCahhIifjrL0gSJB

...
\restrict Mk1wBlQBTeneEpniMJHwqImFhr5sS7WjCxR2HgTmOwhc2BVzshUP3mJ6sWuZOTO
...
8125	مشروب مجاني 	0.00	t	2026-05-18 14:27:29.240609+00	2026-06-27 05:37:33.654319+00	22	t
...
SELECT pg_catalog.setval('public.invoices_id_seq', 187, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6972, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 135, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13791, true);
...
SELECT pg_catalog.setval('public.session_orders_id_seq', 117, true);
...
SELECT pg_catalog.setval('public.sessions_id_seq', 208, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6890, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6885, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16273, true);
...
\unrestrict Mk1wBlQBTeneEpniMJHwqImFhr5sS7WjCxR2HgTmOwhc2BVzshUP3mJ6sWuZOTO

...
\restrict X43rHPKWcLSn8cZ7qzenc1wzBgzuFV5mX6v0rubxHQoD2reWNdAZsOXYwEfNXy2
...
SELECT pg_catalog.setval('public.invoices_id_seq', 158, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5334, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10521, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5250, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5250, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12463, true);
...
\unrestrict X43rHPKWcLSn8cZ7qzenc1wzBgzuFV5mX6v0rubxHQoD2reWNdAZsOXYwEfNXy2

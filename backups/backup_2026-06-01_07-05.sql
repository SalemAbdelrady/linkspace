...
\restrict nXEyYUKpX3rnWWRKEmfGjqPj83Q87zdkDVpfV0nD5ssMncWL6f9hn5c7XeX5iX0
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5304, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10461, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5220, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5220, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12393, true);
...
\unrestrict nXEyYUKpX3rnWWRKEmfGjqPj83Q87zdkDVpfV0nD5ssMncWL6f9hn5c7XeX5iX0

...
\restrict NBiQCnFL27ZOXSsqfU763t8a7a77pCtr2PsZiBo8oifQcEQ9bEhPwBkmdbnPXpW
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6036, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 11925, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5954, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5952, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 14096, true);
...
\unrestrict NBiQCnFL27ZOXSsqfU763t8a7a77pCtr2PsZiBo8oifQcEQ9bEhPwBkmdbnPXpW

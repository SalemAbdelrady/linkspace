...
\restrict 8k1ZiBtRvzFf37JYaiEjSwnUAOXHeIpkQcRebKW3oAaG1G1IAgTTCMyMyVck6NI
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6684, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13221, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6602, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6600, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 15608, true);
...
\unrestrict 8k1ZiBtRvzFf37JYaiEjSwnUAOXHeIpkQcRebKW3oAaG1G1IAgTTCMyMyVck6NI

...
\restrict IzqS5VT8RUUe7JHZi2eQ3diwthNKFGz4VrDo9DHocx105n2dp98gsDdyXVORCxg
...
2	meeting	غرفة الاجتماعات	150.00	100.00	1	2026-06-17 16:31:39.373382+00	2	t	مدير النظام	\N
...
SELECT pg_catalog.setval('public.invoices_id_seq', 189, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7086, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14019, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7004, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6999, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16539, true);
...
\unrestrict IzqS5VT8RUUe7JHZi2eQ3diwthNKFGz4VrDo9DHocx105n2dp98gsDdyXVORCxg

...
\restrict cuGhGjK97QDfcdIQfOWCNaczHMXlE8Zd96HNMeMSssib88ofzpxbbGK7BF2zpcJ
...
171	73	2026-05-25 00:22:25.638716+00	\N	\N	25.00	\N	wallet	active	2026-05-25 00:22:25.638716+00	cowork	منطقة العمل المشتركة	4	\N	f	1	2
\.
...
1	73	1	باقة أساسية	1200.00	0	t	2026-04-25 14:06:56.366856+00	2026-05-24 14:06:56.642+00	active	cash	\N	2026-04-25 14:06:56.366856+00	\N	\N
...
73	سالم علي	01029947833	$2a$12$2l7rINl0qmphBQPBBWiJwu06XKqNcMJI8rOMNwb0mjGtAbYNWFVBK	client	0.00	63	7027644	t	2026-03-21 22:13:02.495873+00	2026-05-24 12:58:08.43196+00	\N	salem.abdulradi@gmail.com	f	\N	\N	f	f	f	f	f	https://res.cloudinary.com/dldzk1eqj/image/upload/v1779627487/linkspace/avatars/hbjxnr2qqmvv7h9vi9uo.jpg	-0103	\N	0	0
...
SELECT pg_catalog.setval('public.invoices_id_seq', 155, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5109, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10071, true);
...
SELECT pg_catalog.setval('public.session_orders_id_seq', 107, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5025, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5025, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 11938, true);
...
\unrestrict cuGhGjK97QDfcdIQfOWCNaczHMXlE8Zd96HNMeMSssib88ofzpxbbGK7BF2zpcJ

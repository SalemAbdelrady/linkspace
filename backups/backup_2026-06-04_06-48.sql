...
\restrict qeMvmi2Wzx7KUnIlsO7zDBo3WJOR5K3GbkPa8x1SG7TK56nnrjzcSI5JesAs2cy
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5316, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10485, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5232, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5232, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12421, true);
...
\unrestrict qeMvmi2Wzx7KUnIlsO7zDBo3WJOR5K3GbkPa8x1SG7TK56nnrjzcSI5JesAs2cy

...
\restrict g7oo3VUDfMnz8NPtU9hI5iM7zdmMefruuEG68nsBrdwrKXsDffMOj2lvoNKUXOm
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6921, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13689, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6839, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6834, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16154, true);
...
\unrestrict g7oo3VUDfMnz8NPtU9hI5iM7zdmMefruuEG68nsBrdwrKXsDffMOj2lvoNKUXOm

...
\restrict hP8AERyd7SB2Xhb546dfxr6nkXiNUAA8iBvbhmsRZpemOuQi3o6jgrMPDUMV2gX
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 7203, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 14253, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 7121, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 7116, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16812, true);
...
\unrestrict hP8AERyd7SB2Xhb546dfxr6nkXiNUAA8iBvbhmsRZpemOuQi3o6jgrMPDUMV2gX

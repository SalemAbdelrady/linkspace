...
\restrict 35UQ5QFfTgm7T9nop0tb82BDL6n51zdX0wkZVFygrMGRwBWku8pg826WNOOGfIV
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6198, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12249, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6116, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6114, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 14474, true);
...
\unrestrict 35UQ5QFfTgm7T9nop0tb82BDL6n51zdX0wkZVFygrMGRwBWku8pg826WNOOGfIV

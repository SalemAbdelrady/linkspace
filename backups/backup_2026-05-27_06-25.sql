...
\restrict dZbmeg1nY6uvhSrmla79PbqlVa82CCNpBcGYZff6B3tC4uwBwiisMYH4csyTGD1
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 5289, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 10431, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 5205, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 5205, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 12358, true);
...
\unrestrict dZbmeg1nY6uvhSrmla79PbqlVa82CCNpBcGYZff6B3tC4uwBwiisMYH4csyTGD1

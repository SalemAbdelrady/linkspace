...
\restrict Gcec5DRGjCdVRaqCXguXe7KklNqJVsEfThjJKn4aPTVbt1G11vXpfvQUqGQleyb
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6918, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 13683, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6836, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6831, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 16147, true);
...
\unrestrict Gcec5DRGjCdVRaqCXguXe7KklNqJVsEfThjJKn4aPTVbt1G11vXpfvQUqGQleyb

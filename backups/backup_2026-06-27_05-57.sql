...
\restrict 5gSbnG9663u3d2vsfbVFGCiGyAWPj72KyTG689U4lrMmMbIHW6LlLFG3uLkasGf
...
189	9011	2026-06-27 05:32:22.80774+00	\N	\N	25.00	\N	wallet	active	2026-06-27 05:32:22.80774+00	cowork	منطقة العمل المشتركة	4	\N	f	1	1
\.
...
SELECT pg_catalog.setval('public.invoices_id_seq', 176, true);
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6540, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12933, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6458, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6456, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 15272, true);
...
SELECT pg_catalog.setval('public.wallet_transactions_id_seq', 53, true);
...
\unrestrict 5gSbnG9663u3d2vsfbVFGCiGyAWPj72KyTG689U4lrMmMbIHW6LlLFG3uLkasGf

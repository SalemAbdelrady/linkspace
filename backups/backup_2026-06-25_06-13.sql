...
\restrict ageGjBNUzJ0ZJFbMAyUsZ7s7wdxNPqKl2xUlL0ObSKB2cbw78ubdbpGmuXrKKd1
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6354, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12561, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6272, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6270, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 14838, true);
...
\unrestrict ageGjBNUzJ0ZJFbMAyUsZ7s7wdxNPqKl2xUlL0ObSKB2cbw78ubdbpGmuXrKKd1

...
\restrict QGcskeOZiRElWHXBqYGjg5go2Jxe11ZRBEeBiCwsRbLZzvwNQbDKv1igaCWLl6D
...
SELECT pg_catalog.setval('public.price_settings_id_seq', 6297, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 12447, true);
...
SELECT pg_catalog.setval('public.space_settings_id_seq', 6215, true);
...
SELECT pg_catalog.setval('public.subscription_plans_id_seq', 6213, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 14705, true);
...
\unrestrict QGcskeOZiRElWHXBqYGjg5go2Jxe11ZRBEeBiCwsRbLZzvwNQbDKv1igaCWLl6D

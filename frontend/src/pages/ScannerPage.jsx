    ...
    <div style={{ minHeight: "100vh", padding: 16 }}>
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        {currentSpace && (
          ...
          >
            <span>
              {SPACE_ICONS[selectedSpace]} {currentSpace.name}
            </span>
            <span>
              أول ساعة:{" "}
              <strong style={{ color: "var(--accent)" }}>
                {currentSpace.first_hour} ج
              </strong>{" "}
              · الحد الأقصى:{" "}
              <strong style={{ color: "var(--accent)" }}>
                {currentSpace.max_hours} ساعة
              </strong>
            </span>
          </div>
        )}
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              transition: "all 0.2s",
              borderColor:
                scanMode === mode ? "var(--accent)" : "var(--border)",
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  borderStyle: "solid",
                  ...Object.fromEntries(s.split(";").map((p) => p.split(":"))),
                }}
              />
            ))}
        ...
        >
          ...
          {result.session?.spaceName && (
            <div
              style={{ fontSize: 12, color: "var(--accent)", marginBottom: 8 }}
            >
              {SPACE_ICONS[result.session.spaceKey] || "🏢"}{" "}
              {result.session.spaceName}
            </div>
          )}
          {result.action === "checkin" ? (
            ...
            <>
              <div className="stat-row">
                ...
                <span className="stat-val">
                  {getBilledHours(
                    result.session.durationMin,
                    result.session.maxHours,
                  )}{" "}
                  ساعة{" "}
                  <span
                    style={{
